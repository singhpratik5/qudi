...
class CellSegmentationSparse:
    """
    Robust cell boundary segmentation for SPARSE / well-separated samples.

    Uses Log-Scale Dynamic Range Compression, MAD noise-floor bounded adaptive
    thresholding, and seeded hysteresis region propagation. Works best on
    Confocal1/Confocal2 type samples with well-separated cells.

    Note: Renamed from CellSegmentationLogic to CellSegmentationSparse to
    co-exist with CellSegmentationLogic (dense variant) in the
